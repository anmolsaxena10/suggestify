...
exports.insertPrefix = function(prefix, tenant, suggestions){
    ...
    col.findOneAndUpdate(...args, (err, result) => console.log(result));
}

exports.deletePrefix = function(prefix, tenant){
    mongoCon.db.collection(tenant.tenant_id).findOneAndDelete({prefix}, (err, result) => console.log(result));
}
...
exports.persistPrefixes = async function(prefixes, tenant){
    for(var i=0 ; i<prefixes.length ; i++){
        ...
        console.log('hererererererererererere'+suggestions);
